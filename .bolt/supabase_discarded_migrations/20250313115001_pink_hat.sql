/*
  # Add newsletter table to content management
...
CREATE INDEX IF NOT EXISTS content_table_newsletters_content_idx ON content_table_newsletters USING gin(to_tsvector('english', content));
...
COMMENT ON COLUMN content_table_newsletters.content IS 'The main body content of the newsletter';
...
-- Create content update function
